...
export default function ImageCropper({ imageSrc, onCropComplete, onCancel }: ImageCropperProps) {
  ...
  const cropperContent = (
    <div className="fixed inset-0 bg-black/90 z-[9999] flex flex-col md:items-center md:justify-center md:p-8 backdrop-blur-sm">
      ...
      <div className="flex flex-col w-full h-full md:w-full md:max-w-sm md:h-[650px] mx-auto bg-black md:rounded-3xl overflow-hidden md:shadow-2xl md:border md:border-gray-800">
